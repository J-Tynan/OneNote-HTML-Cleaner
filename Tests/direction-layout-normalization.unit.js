...
(function main() {
  ...
  {
    const doc = createDoc('<html><body><main><div style="direction: ltr; margin-top:0; margin-left:0; width:7in"><div style="direction: ltr; margin-top:0; margin-left:.2in; width:3in"><h1>Page Title</h1></div><div style="direction: ltr; margin-top:.04in; margin-left:.2in; width:2in"><p>Thursday, April 25, 2024</p><p>4:27 PM</p></div></div></main></body></html>');
    const logs = normalizeDirectionLayoutContainers(doc, {
      unwrapRedundantWrappers: true,
      normalizeTopLevelPageWidths: true,
